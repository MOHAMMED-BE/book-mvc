...
$routeDisplay = ucwords(str_replace(['book',  'index'], ['Book', 'List'], $routeDisplay));
    ...
    <div class="d-flex parent">
        <div class="sidebar bg-dark text-white d-flex flex-column">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($route ?? '') === 'book/index' ? 'active' : ''; ?>" href="index.php?book/index">
                        <i class="bi bi-house-door"></i> Book List
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($route ?? '') === 'book/create' ? 'active' : ''; ?>" href="index.php?book/create">
